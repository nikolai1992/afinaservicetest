...
//		);
	...
	public static function theme_js() {
		...
		wp_enqueue_script( 'run-slider', $dir . 'run_slide.js', array( 'jquery' ), $theme_version, true );
	}
...
wp_enqueue_script('my-ajax-script', get_template_directory_uri() . '/assets/js/my-ajax-script.js', array('jquery'), null, true); // Localize the script with new data
wp_localize_script('my-ajax-script', 'my_ajax_object', array( 'ajax_url' => admin_url('admin-ajax.php'), 'nonce' => wp_create_nonce('my_ajax_nonce') ));
